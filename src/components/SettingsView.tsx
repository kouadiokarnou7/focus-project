  ...
  return (
    <div className="flex flex-col gap-6 w-full font-sans">
      ...
      <div>
        ...
        <p className="text-xs text-on-surface-variant mt-1">Personnalisez votre expérience FocusFlow et ajustez vos temps de cycle.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <form onSubmit={handleSave} className="lg:col-span-8 glass-panel rounded-xl p-6 md:p-8 space-y-6">
          ...
          <div className="pt-6 flex justify-end">
            <button
              type="submit"
              className="bg-primary-container text-white py-2.5 px-6 rounded-lg shadow-[0_0_15px_rgba(255,107,26,0.15)] hover:brightness-105 transition-all text-xs font-bold active:scale-95"
            >
